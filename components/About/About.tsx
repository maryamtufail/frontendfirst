...
const About = () => {
  return (
    <section className="about flex md:flex-row flex-col bg-contwo items-center w-full justify-center py-20">
      ...
      <div className="md:w-1/2 w-full flex flex-col justify-center md:pr-[6rem] md:pl-[4rem] py-[1rem] px-3">
