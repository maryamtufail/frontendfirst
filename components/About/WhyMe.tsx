...
const WhyMe = () => {
    ...
    return (
        <section className="home flex items-center w-full flex-col justify-center md:px-[15rem] px-10 md:py-[7rem] py-[3rem] text-center bg-secondary text-secondary">
            ...
            <Roll triggerOnce className="font-bold cursor-pointer rounded-lg transition delay-50 px-24 py-3  bg-paccent text-secondary hover:bg-saccent hover:text-primary mt-[3rem]">
