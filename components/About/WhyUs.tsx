    ...
    return (
        <section className="home flex items-center w-full flex-col justify-center md:px-[15rem] px-3 md:py-[7rem] py-[3rem] text-center bg-yellow text-primary">
            <div className="max-w-4xl mx-auto">
                ...
                <Slide triggerOnce className='md:text-lg text-md mt-5'><p className="mb-3">First off, I want to say that I&apos;m really excited to connect with all of you. I am in same boat as a small front-end developer business owner for quite some time now. </p>
