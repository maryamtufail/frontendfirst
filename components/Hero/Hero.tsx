  ...
  return (
    <section className="home flex items-center w-full flex-col justify-center md:px-[15rem] px-10 md:py-[9rem] py-[3rem] text-center">
     <Slide triggerOnce className="py-6 text-4xl md:text-7xl  font-bold"> <h1>Level up your Web<span className='text-conone'> Presence</span></h1></Slide> 
      <Slide triggerOnce  className='md:text-xl text-md'><p>FrontendFirst is dedicated to boosting your online presence with cutting-edge designs and agile methodologies. Don&apos;t miss out on the opportunity to enhance your business. Take action now and witness the remarkable benefits firsthand.</p></Slide>
