...
const Footer = () => {
  ...
  return (
    <footer className="bg-primary p-[3rem] text-secondary">
      <div className="w-full flex md:flex-row flex-col px-7 py-[4rem] mx-auto  rounded-lg bg-secondary ">
        <div className="w-full md:w-1/2 mb-12 md:px-[4rem] ">
          <h3 className="text-2xl md:text-5xl font-bold">Let&apos;s Meet for a Brown Tea <br />Chat - Virtually</h3>
