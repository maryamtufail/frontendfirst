  ...
  return (
    <footer className="bg-primary p-[3rem] text-primary items-center flex flex-col">
      ...
      <div className="mt-2 w-full flex md:flex-row flex-col px-7 py-[4rem] mx-auto  rounded-lg bg-secondary ">
        ...
        <a href="https:www.instagram.com/frontendfirst" className='flex items-center' aria-label="Instagram"><FiInstagram className=' mr-2 inline md:w-8 h-8'/> Instagram</a>
        <a href="https:www.linkedin.com/in/maryam-tufail7" className='flex items-center' aria-label="Linkedin"> <FiLinkedin className=' mr-2 inline md:w-8 h-8'/> LinkedIn</a>
        </div>
      </div>
    </footer>
  );
